...
<div class="container mt-5">
    ...
    <div class="d-flex justify-content-between mb-4">
        <a href="{{ route('learning-materials.create') }}" class="btn btn-primary rounded-pill px-4">
            ...
            <tbody>
                @foreach($learningMaterials as $index => $material)
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="{{ route('learning-materials.edit', $material->id) }}" class="btn btn-sm btn-warning me-2"><i class="fa fa-edit"></i></a> 
                            <button type="button" class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#deleteModal" 
                                onclick="setDeleteAction('{{ route('learning-materials.destroy', $material->id) }}')">
