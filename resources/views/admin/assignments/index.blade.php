...
<div class="container mt-5">
        ...
        <div class="d-flex justify-content-between mb-3">
            <a href="{{ route('admin.assignments.create') }}" class="btn btn-primary rounded-pill px-4">
                <i class="fas fa-plus"></i> New Assignment
            </a>
            <a href="{{ route('admin.submissions.index') }}" class="btn btn-primary rounded-pill px-4">
            ...
            <table class="table table-hover table-bordered align-middle" style="border-radius: 10px; overflow: hidden;">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="{{ route('admin.assignments.edit', $assignment->id) }}" class="btn btn-sm btn-warning me-2">
